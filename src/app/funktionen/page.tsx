  ...
  return (
    <div style={{ minHeight: "100vh", background: "var(--bg)" }}>
      ...
      <main style={{ paddingTop: "58px" }}>
        ...
        {/* ── HERO ─────────────────────────────────────────────── */}
        <div style={{ textAlign: "center", maxWidth: "800px", margin: "0 auto", padding: "72px 40px 64px" }}>
          <p className="label-caps" style={{ marginBottom: "16px" }}>Was Faktura kann</p>
          <h1 style={{
          ...
          <p style={{
            ...
            Faktura ist ein fokussiertes Rechnungstool. Keine überladenen Menüs, keine unnötigen Features – nur das, was Freelancer wirklich täglich brauchen.
          </p>
